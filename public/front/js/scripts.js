...
$(function () {
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'front/images/logo.png');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'front/images/logo-beyaz.png');
        }
    });
    ...
    $('.topnav .menu-icon').on('click', function () {
        ...
        if (open) {
            ...
            logoChan.attr('src', '/front/images/logo-beyaz.png');
            ...
            logoChan.attr('src', '/front/images/logo.png');
