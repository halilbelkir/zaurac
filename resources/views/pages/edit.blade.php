                ...
                <form action="{{route('pages.update',$pages->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                        <div>
                            ...
                            @else
                                <x-jet-input id="title" name="title" onkeyup="seflink1(this.value,'#seflink')" type="text" value="{{$pages->title}}" class="mt-1 block"  placeholder="Başlık" />
                            @endif
                        ...
                        <div>
                            ...
                            @else
                                <x-jet-input id="seflink" name="seflink" type="text" value="{{$pages->seflink}}" class="mt-1 block"  placeholder="Seflink" />
                            @endif
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 mb-3 mt-3">
                        <div>
                            ...
                            @else
                                <x-jet-input id="tag" name="tag" type="text" value="{{$pages->tag}}" class="mt-1 block"  placeholder="Etiket (Kelimeleri virgül ile ayırınız.)" />
                            @endif
