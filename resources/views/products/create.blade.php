                ...
                <form action="{{route('products.store')}}" method="post">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                        <div>
                            ...
                            <x-jet-input id="ad" name="ad" onkeyup="seflink1(this.value,'#seflink')"  type="text" value="{{old('ad')}}" class="mt-1 block" autocomplete="ad" placeholder="Ad" />
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="aciklama" name="aciklama" class="mt-1 mb-1 block border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" autocomplete="aciklama" placeholder="Aciklama" rows="2">@if(!empty(old('aciklama'))){{old('aciklama')}}@endif</textarea>
